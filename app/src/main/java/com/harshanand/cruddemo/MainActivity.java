...
public class MainActivity extends AppCompatActivity {
    ...
    String url = "https://crudappdb.000webhostapp.com/retrieve.php";
    Employee employee;
    @Override
    ...
    private void deleteData(final String id) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, "https://crudappdb.000webhostapp.com/delete.php",
